...
// using tensorrt_llm::kernels::cutlass_kernels::ActivationType;
...
class BTCutlassFpAIntBGemmRunnerInterface
{
public:
    BTCutlassFpAIntBGemmRunnerInterface() {}

    virtual ~BTCutlassFpAIntBGemmRunnerInterface() {}
...
class BTCutlassFpAIntBGemmRunner : public virtual BTCutlassFpAIntBGemmRunnerInterface
{
public:
    BTCutlassFpAIntBGemmRunner();
    ~BTCutlassFpAIntBGemmRunner();
