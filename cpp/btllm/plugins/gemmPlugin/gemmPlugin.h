...
#include "btllm/plugins/common/pluginUtils.h"
...
public:
    ...
    void configurePlugin(size_t minM, size_t maxM, size_t N, size_t K) noexcept;
    // size_t getWorkspaceSize(nvinfer1::PluginTensorDesc const* inputs, int nbInputs,
    //     nvinfer1::PluginTensorDesc const* outputs, int nbOutputs) const noexcept override;
    size_t getWorkspaceSize() const noexcept ;
    // int enqueue(nvinfer1::PluginTensorDesc const* inputDesc, nvinfer1::PluginTensorDesc const* outputDesc,
    //     void const* const* inputs, void* const* outputs, void* workspace, cudaStream_t stream) noexcept override;
    int enqueue(size_t rowA, size_t colA, size_t rowB, size_t colB, void const* A, void const* B, void* outputs, void* workspace, cudaStream_t stream) noexcept;
...
public:
    ...
    GemmPlugin* createPlugin(size_t minM, size_t maxM, size_t N, size_t K, int transA, int transB, int padLda, int padLdb, nvinfer1::DataType type, bool useFp8 = false) noexcept;
