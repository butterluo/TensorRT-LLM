...
@# 
Debug:
python3 ./scripts/build_wheel.py --cuda_architectures "80-real;86-real" --trt_root /usr/local/tensorrt --skip_building_wheel --build_type Debug --install --use_ccache --fast_build --benchmarks --micro_benchmarks --job_count 16 -D "ENABLE_MULTI_DEVICE=1" -D "ENABLE_FP8=0" -D "NVTX_DISABLE=1" -D "FAST_MATH=1" -D "CUTLASS_HOME=/home/SRC/MLSys/HPC/GPU/cutlass" -D "NVTX_HOME=/home/SRC/MLSys/HPC/GPU/NVTX" -D "JSON_HOME=/home/SRC/Lang/json" -D "CXXOPTS_HOME=/home/SRC/Lang/cxxopts" -D "GOOGLETEST_HOME=/home/SRC/Lang/googletest" -D "CMAKE_VERBOSE_MAKEFILE=ON" -D "CMAKE_EXPORT_COMPILE_COMMANDS:BOOL=TRUE" --clean

Release:
python3 ./scripts/build_wheel.py --cuda_architectures "80-real;86-real" --trt_root /usr/local/tensorrt --skip_building_wheel --build_type Release --install --use_ccache --fast_build --benchmarks --micro_benchmarks --job_count 16 -D "ENABLE_MULTI_DEVICE=1" -D "ENABLE_FP8=0" -D "NVTX_DISABLE=1" -D "FAST_MATH=1" -D "CUTLASS_HOME=/home/SRC/MLSys/HPC/GPU/cutlass" -D "NVTX_HOME=/home/SRC/MLSys/HPC/GPU/NVTX" -D "JSON_HOME=/home/SRC/Lang/json" -D "CXXOPTS_HOME=/home/SRC/Lang/cxxopts" -D "GOOGLETEST_HOME=/home/SRC/Lang/googletest" -D "CMAKE_VERBOSE_MAKEFILE=ON" -D "CMAKE_EXPORT_COMPILE_COMMANDS:BOOL=TRUE" --clean
