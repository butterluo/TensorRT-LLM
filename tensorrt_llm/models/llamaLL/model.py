...
class LLaMALLModel(Module):
    ...
    def forward(
        ...
        if self.mapping.is_first_pp_rank():
            ...
            residual = hidden_states
            hidden_states = self.ln_f(hidden_states) #@#MODIFY
        else:
        ...
        # else:
        #     hidden_states = send(hidden_states, self.mapping.next_pp_rank()) @#MODIFY change to below line
