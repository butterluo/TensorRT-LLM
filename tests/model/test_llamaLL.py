...
class TestLLaMALL(unittest.TestCase):
    EOS_TOKEN = 2
    PAD_TOKEN = 2
    ...
    def _gen_tensorrt_llm_network(self, network, hf_llama,
        ...
        with net_guard(network):
            ...
            # Initialize model
            tensorrt_llm_llama = tensorrt_llm.models.LLaMALLForCausalLM(
...
"""
    ...
    def test_loaders(self, paths, tp_info, emb_sharding_dim):
        ...
        return
"""
#use ctrl+f10 to run py file in terminal
if __name__ == '__main__':
    ...
    # suite.addTest(TestLLaMA('test_llama'))   # 添加测试用例test_sub_1()
    # suite.addTest(TestLLaMA('test_add_1'))
    # runner = unittest.TextTestRunner(verbosity=2,failfast=True)     # 执行测试用例
    # runner.run(suite)
